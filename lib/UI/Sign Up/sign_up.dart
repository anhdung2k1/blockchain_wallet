import 'package:block_chain/Authentication/authentication.dart';
import 'package:block_chain/UI/LogIn/google_sign_in/google_sign_in.dart';
import 'package:block_chain/UI/LogIn/widgets/form_error.dart';
  ...
  TextFormField buildEmailFormField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          suffixIcon:
              Icon(Icons.mail_outlined, color: Colors.white.withOpacity(0.6)),
          contentPadding:
  ...
  TextFormField buildNameFormField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          floatingLabelBehavior: FloatingLabelBehavior.always,
          suffixIcon:
              Icon(Icons.people_outlined, color: Colors.white.withOpacity(0.6)),
          contentPadding:
              const EdgeInsets.symmetric(horizontal: 42, vertical: 20),
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(20),
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              ...
                              side: const BorderSide(
                                  width: 2, color: Color(0xFFb91372))),
                        ),
                      ),
                      const SizedBox(height: 20),
                      Row(
